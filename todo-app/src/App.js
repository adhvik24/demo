        ...
        <div className="container mx-auto px-4 py-8 max-w-2xl">
          ...
          <form onSubmit={addTodo} className="mb-6">
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
              >
                Add
              </button>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-colors duration-300">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              {filteredTodos.length === 0 ? (
                ...
                filteredTodos.map((todo) => (
                  <div
                    key={todo.id}
                    className="flex items-center gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150 group"
                  >
                    <button
                      onClick={() => toggleTodo(todo.id)}
                      className="flex-shrink-0 w-6 h-6 rounded-full border-2 border-gray-300 dark:border-gray-600 flex items-center justify-center transition-all duration-200 hover:border-indigo-500 dark:hover:border-indigo-400"
            ...
            {todos.length > 0 && (
              <div className="px-6 py-4 bg-gray-50 dark:bg-gray-750 flex justify-between items-center border-t border-gray-200 dark:border-gray-700">
